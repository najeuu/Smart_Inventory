    ...
    <div class="bg-gray-100 font-poppins leading-normal tracking-normal">
        ...
        <div class="w-full p-8">
            ...
            <div id="ajukan-peminjaman"
                ...
                <div
                    class="bg-white w-1/2 p-5 rounded-lg shadow-lg transform -translate-y-full transition-transform duration-500">
                    ...
                    <form action="{{ route('peminjaman.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_mahasiswa" class="w-full px-3 py-2 border rounded-lg"
                        ...
                        <div class="mb-4">
                            ...
                            <select name="jenis_barang" id="jenis_barang"
                                class="w-full px-3 py-2 border rounded-lg block text-gray-700" required>
                                <option value="" disabled selected>Pilih Jenis Barang</option>
                                @foreach ($dataBarang as $barang)
                                    <option value="{{ $barang->nama_barang }}" data-id="{{ $barang->id }}">
