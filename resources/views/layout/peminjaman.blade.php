...
<body class="bg-orange-50">
    <div class="flex min-h-screen">
        <!-- Sidebar -->
        <aside class="w-64 bg-orange-100 p-4 hidden md:flex md:flex-col rounded-tr-3xl rounded-br-3xl mr-4">
            <div class="flex items-center mb-8 space-x-4">
                <img src="{{ url('/image/logo.png') }}" class="h-12" alt="Logo">
                <h2 class="text-lg font-bold text-gray-800">MANAJEMEN BARANG LABORAN</h2>
            </div>
            <nav class="space-y-2 flex flex-col">
                <a href="" class="flex items-center p-2 rounded hover:bg-orange-200 transition-colors">
                ...
                <!--menu peminjaman-->
                <a href="" class="flex items-center p-2 bg-orange-200 rounded transition-colors">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
